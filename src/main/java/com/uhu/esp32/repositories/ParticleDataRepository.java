...
public interface ParticleDataRepository extends JpaRepository<ParticleData, Long>
{
    ...
    @NativeQuery(value = """
        ...
        ORDER BY hour_group
        """)
    public List<Object[]> findPM10AverageByHourFromDay(String date, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY hour_group
        """)
    public List<Object[]> findPM10MaximumByHourFromDay(String date, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY hour_group
        """)
    public List<Object[]> findPM10MinimumByHourFromDay(String date, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY hour_group
        """)
    public List<Object[]> findPM25AverageByHourFromDay(String date, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY hour_group
        """)
    public List<Object[]> findPM25MaximumByHourFromDay(String date, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY hour_group
        """)
    public List<Object[]> findPM25MinimumByHourFromDay(String date, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY 
            dia;
        """)
    public List<Object[]> findPM10AverageByDateRange(String startDate, String endDate, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY 
            dia;
        """)
    public List<Object[]> findPM10MaximumByDateRange(String startDate, String endDate, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY 
            dia;
        """)
    public List<Object[]> findPM10MinimumByDateRange(String startDate, String endDate, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY 
            dia;
        """)
    public List<Object[]> findPM25AverageByDateRange(String startDate, String endDate, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY 
            dia;
        """)
    public List<Object[]> findPM25MaximumByDateRange(String startDate, String endDate, String latitude, String longitude);
    ...
    @NativeQuery(value = """
        ...
        ORDER BY 
            dia;
        """)
    public List<Object[]> findPM25MinimumByDateRange(String startDate, String endDate, String latitude, String longitude);
}
