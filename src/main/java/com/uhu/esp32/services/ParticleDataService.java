...
public class ParticleDataService 
{
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByHourFromDay<Float>> findPM10AverageByHourFromDay(String date, String latitude, String longitude)
    {
        List<ParticleGraphDataByHourFromDay<Float>> particleGraphDataByHourFromDayList = new ArrayList<>();
        List<Object[]> pm10AverageList = this.particleDataRepository.findPM10AverageByHourFromDay(date, latitude, longitude);
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByHourFromDay<Integer>> findPM10MaximumByHourFromDay(String date, String latitude, String longitude)
    {
        List<ParticleGraphDataByHourFromDay<Integer>> particleGraphDataByHourFromDayList = new ArrayList<>();
        List<Object[]> pm10MaximumList = this.particleDataRepository.findPM10MaximumByHourFromDay(date, latitude, longitude);
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByHourFromDay<Integer>> findPM10MinimumByHourFromDay(String date, String latitude, String longitude)
    {
        List<ParticleGraphDataByHourFromDay<Integer>> particleGraphDataByHourFromDayList = new ArrayList<>();
        List<Object[]> pm10MinimumList = this.particleDataRepository.findPM10MinimumByHourFromDay(date, latitude, longitude);
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByHourFromDay<Float>> findPM25AverageByHourFromDay(String date, String latitude, String longitude)
    {
        List<ParticleGraphDataByHourFromDay<Float>> particleGraphDataByHourFromDayList = new ArrayList<>();
        List<Object[]> pm25AverageList = this.particleDataRepository.findPM25AverageByHourFromDay(date, latitude, longitude);
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByHourFromDay<Integer>> findPM25MaximumByHourFromDay(String date, String latitude, String longitude)
    {
        List<ParticleGraphDataByHourFromDay<Integer>> particleGraphDataByHourFromDayList = new ArrayList<>();
        List<Object[]> pm25MaximumList = this.particleDataRepository.findPM25MaximumByHourFromDay(date, latitude, longitude);
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByHourFromDay<Integer>> findPM25MinimumByHourFromDay(String date, String latitude, String longitude)
    {
        List<ParticleGraphDataByHourFromDay<Integer>> particleGraphDataByHourFromDayList = new ArrayList<>();
        List<Object[]> pm25MinimumList = this.particleDataRepository.findPM25MinimumByHourFromDay(date, latitude, longitude);
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByDate<Float>> findPM10AverageByDateRange(LocalDate startDate, LocalDate endDate, String latitude, String longitude)
    {
        List<ParticleGraphDataByDate<Float>> particleGraphDataByDateList = new ArrayList<>();
        List<Object[]> pm10AverageList = this.particleDataRepository
                .findPM10AverageByDateRange(startDate.format(DateTimeFormatter.ISO_DATE), 
                        endDate.format(DateTimeFormatter.ISO_DATE), latitude, longitude);
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByDate<Integer>> findPM10MaximumByDateRange(LocalDate startDate, LocalDate endDate, String latitude, String longitude)
    {
        List<ParticleGraphDataByDate<Integer>> particleGraphDataByDateList = new ArrayList<>();
        List<Object[]> pm10MaximumList = this.particleDataRepository
                .findPM10MaximumByDateRange(startDate.format(DateTimeFormatter.ISO_DATE), 
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByDate<Integer>> findPM10MinimumByDateRange(LocalDate startDate, LocalDate endDate, String latitude, String longitude)
    {
        List<ParticleGraphDataByDate<Integer>> particleGraphDataByDateList = new ArrayList<>();
        List<Object[]> pm10MinimumList = this.particleDataRepository
                .findPM10MinimumByDateRange(startDate.format(DateTimeFormatter.ISO_DATE), 
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByDate<Float>> findPM25AverageByDateRange(LocalDate startDate, LocalDate endDate, String latitude, String longitude)
    {
        List<ParticleGraphDataByDate<Float>> particleGraphDataByDateList = new ArrayList<>();
        List<Object[]> pm25AverageList = this.particleDataRepository
                .findPM25AverageByDateRange(startDate.format(DateTimeFormatter.ISO_DATE), 
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByDate<Integer>> findPM25MaximumByDateRange(LocalDate startDate, LocalDate endDate, String latitude, String longitude)
    {
        List<ParticleGraphDataByDate<Integer>> particleGraphDataByDateList = new ArrayList<>();
        List<Object[]> pm25MaximumList = this.particleDataRepository
                .findPM25MaximumByDateRange(startDate.format(DateTimeFormatter.ISO_DATE), 
    ...
    @Transactional(readOnly = false)
    public List<ParticleGraphDataByDate<Integer>> findPM25MinimumByDateRange(LocalDate startDate, LocalDate endDate, String latitude, String longitude)
    {
        List<ParticleGraphDataByDate<Integer>> particleGraphDataByDateList = new ArrayList<>();
        List<Object[]> pm25MinimumList = this.particleDataRepository
                .findPM25MinimumByDateRange(startDate.format(DateTimeFormatter.ISO_DATE), 
